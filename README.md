...
<img width="2624" height="1874" alt="image" src="https://github.com/user-attachments/assets/f3b233eb-f5eb-4947-97ab-e2c324b26477" />
...
One based on Java multithreaded programming, using only default/platform threads;
A variant applying Task-based approach, using Java Executor Framework, where useful.
...
The assignment-01folder in the repo includes two sketches that could be used as a starting point

sketch01 is an example of main loop using a sequential approach to implement the dynamics of the bouncing balls, as requested in the game
sketch02 is an example of a GUI program with asynchronous input from the keyboard, architected using MVC
The deliverable
