...
The execution follows a structured four-phase pattern within each game loop iteration:
...
\begin{enumerate}
    ...
    \item \textbf{Phase 3 (Parallel Player Updates)}: \texttt{workerPool.parallelPlayerUpdates()} distributes player state updates
    \item \textbf{Phase 4 (Sequential Hole Logic)}
\end{enumerate}
